...
public class DatabaseManager {
	...
	public static void loadTabelas() throws SQLException {
		...
		st.execute("CREATE TABLE IF NOT EXISTS VENDAS (NUMERODOPEDIDO NUMERIC NOT NULL UNIQUE, CODIGO NUMERIC NOT NULL, NOMEDOCLIENTE VARCHAR, SABOR VARCHAR, VALORUNIDADE NUMERIC, VALORVENDA NUMERIC, VALORTOTAL NUMERIC, ESTOQUEVENDA NUMERIC, ESTOQUEATIVO NUMERIC, ESTOQUEVENDIDO NUMERIC, PRIMARY KEY (NUMERODOPEDIDO))");
		st.close();
	}
