...
// 	Criando as tabelas do banco de dados
	public static void loadTabelas() throws SQLException {
		...
		st.execute("CREATE TABLE IF NOT EXISTS VENDAS (CODIGO NUMERIC NOT NULL, SABOR VARCHAR UNIQUE, VALORUNIDADE NUMERIC, VALORVENDA NUMERIC, VALORTOTAL NUMERIC, ESTOQUEVENDA NUMERIC, ESTOQUEATIVO NUMERIC, ESTOQUEVENDIDO NUMERIC, PRIMARY KEY(CODIGO))");
